        ...
        <div className={style.one}>
          <div className={style.input_field}>
            ...
            <select className={style.options} onClick={selectData}>
              ...
              <option value="2">Citizen registration (25 years & above) </option>
              <option value="3">All officers and employees of the Government Health and Family Planning Department</option>
              <option value="4">Approved private health and family planning officers-employees </option>
              <option value="5">All directly involved government and private health care officers=employess </option>
              <option value="2">Heroic freedom fighters and heroines </option>
              <option value="2">Front-line law enforcement agency </option>
              <option value="2">Military and paramilitary defense forces </option>
              <option value="2">Civilian Aircraft </option>
              <option value="2">Essential Offices for governance the state </option>
              ...
              <option value="2">Front-line officers and employess of City Corporation and the municipality </option>
              <option value="2">Religiour Representatives (of all religions) </option>
              <option value="2">Engaged in burial </option>
              <option value="2">Government officials and employees at the forefront of emergency electrcity, water, gas, sewerage and fire services. </option>
              <option value="2">Government officials and employess of railway stations, airports, Land ports and seaprots </option>
              <option value="2">Government officials and involved in emergency public service in districts and upazilas </option>
